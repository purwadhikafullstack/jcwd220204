...
const RoomCard = ({
  ...
  const getImagesNew = room.map(
    (val) => `https://jcwd220204.purwadhikabootcamp.com/projects/server/public/${val.picture_url}`
  )
                            ...
                            {images.map((val) => (
                              ...
                              >
                                <Image
                                  ...
                                  boxSize="100%"
                                  objectFit="cover"
                                  src={`https://jcwd220204.purwadhikabootcamp.com/projects/server/public/${val.picture_url}`}
                                  alt="upload"
                                />
