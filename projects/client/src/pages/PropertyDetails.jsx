      ...
      <div className="container mx-auto min-h-[800px] mb-14 ">
        ...
        <div className="flex flex-col items-start gap-8 lg:flex-row">
          <div className="max-w-[768px]">
            ...
            <div>
              <h3 className="text-blue-700 font-semibold">Facility :Wifi, Breakfast, Swimming Pool, Gym Area , & Meeting room.</h3>
            </div>
          </div>
          <div className="flex-1 bg-white w-full mb-8 border-gray-300 rounded-lg px-6 py-8">
            ...
            <form className="flex flex-col gap-y-4">
              <input className="border border-gray-300 focus:border-blue-700 outline-none rounded w-full px-4 h-10 text-sm" type="text" placeholder="Name*" />
              <input className="border border-gray-300 focus:border-blue-700 outline-none rounded w-full px-4 h-10 text-sm" type="text" placeholder="Email*" />
              <input className="border border-gray-300 focus:border-blue-700 outline-none rounded w-full px-4 h-10 text-sm" type="text" placeholder="Phone*" />
              <textarea
